...
document.querySelector("#q1-btn-yellow").onclick = yellowButtonClicked;
...
document.querySelector("#q1-btn-green").onclick = greenButtonClicked;
...
document.querySelector("#q1-btn-lightblue").onclick = lightBlueButtonClicked;
...
document.querySelector("#q1-btn-blue").onclick = blueButtonClicked;
